...
function calcularCosto() {
    ...
    if (kilometros >= 0 && kilometros < 0.3) {
        ...
        resultadoTexto = "Cobrar al cliente: $250 (Es como ir a agora, zona colonia, san carlos)";
        resultadonumerico = 250;
    } else if (kilometros > 5.0 && kilometros <= 8.0) {
        resultadoTexto = "Cobrar al cliente: $300 (Es como si fueras a la parada maria montes, eduardo brito)";
        resultadonumerico = 300;
    } else if (kilometros > 8.0 && kilometros <= 12.9) {
        resultadoTexto = "Cobrar al cliente: $350 (Es como si fueras a megacentro o mama tingo)";
        resultadonumerico = 350;
    } else if (kilometros > 12.9 && kilometros <= 15.0) {
        resultadoTexto = "Cobrar al cliente: $400 (Villa carmen en las charles)";
        resultadonumerico = 400;
    } else if (kilometros > 15.0 && kilometros <= 17) {
        resultadoTexto = "Cobrar al cliente: $450 (Es como si fueras a hainamisa)";
        resultadonumerico = 450;
    } else if (kilometros > 17.0 && kilometros <= 18.7) {
        resultadoTexto = "Cobrar al cliente: $600 (Es como si fueras a san luis)";
        resultadonumerico = 600;
    } else if (kilometros > 18.7 && kilometros <= 20) {
        resultadoTexto = "Cobrar al cliente: $650 (Es como si fueras el hipodromo)";
        resultadonumerico = 650;
    } else if (kilometros > 20.0 && kilometros <= 25) {
        resultadoTexto = "Cobrar al cliente: $650 (Es como si fueras mas para a ya del hipodromo)";
        resultadonumerico = 650;
    } else if (kilometros > 25.0 && kilometros <= 30) {
        resultadoTexto = "Cobrar al cliente: $700 (Entre hipodromo y Ole de la caleta o Parque San cristobal)";
